            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Blog Berita</h4>
                    </div>
                                                        ...
                                                        <div class="card-body">
                                                            <form action="{{ route('blog.store') }}" method="POST" enctype="multipart/form-data">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea class="form-control @error('kutipan') is-invalid @enderror" name="kutipan" rows="5" placeholder="Masukkan Kutipan Blog">{{ old('kutipan') }}</textarea>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea class="form-control @error('waktupost') is-invalid @enderror" name="waktupost" rows="5" placeholder="Masukkan Waktu Post Blog">{{ old('waktupost') }}</textarea>
