                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="card border-0 shadow rounded">
                                                        <div class="card-body">
                                                            <a href="{{ route('slide.create') }}" class="btn btn-md btn-success mb-3">TAMBAH SLIDE SHOW</a>
                                                            <form action="{{route('slide.index') }}" method="GET">
                                                                <div class="input-group">
                                                                    <input type="text" class="form-control" name="cari" placeholder="Cari Konten" value="{{$request->cari}}">
                                                            ...
                                                            <table class="table table-bordered">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>{!! $slide->content !!}</td>
                                                                        <td class="text-center">
                                                                            <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('slide.destroy', $slide->id) }}" method="POST">
                                                                                <a href="{{ route('slide.edit', $slide->id) }}" class="btn btn-sm btn-primary">EDIT</a>
                                                                                @csrf
                                                                                @method('DELETE')
