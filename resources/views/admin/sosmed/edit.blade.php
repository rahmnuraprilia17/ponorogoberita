                                                        ...
                                                        <div class="card-body">
                                                            <form action="{{ route('sosmed.update', $sosmed->id) }}" method="POST" enctype="multipart/form-data">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control @error('jenis') is-invalid @enderror" name="jenis" value="{{ old('jenis', $sosmed->jenis) }}" placeholder="Masukkan Jenis Sosmed">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', $sosmed->name) }}" placeholder="Masukkan Icon Sosmed">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea class="form-control @error('link') is-invalid @enderror" name="link" rows="5" placeholder="Masukkan Nama Link">{{ old('link', $sosmed->link) }}</textarea>
