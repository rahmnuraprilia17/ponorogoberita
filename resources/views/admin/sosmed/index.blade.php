                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="card border-0 shadow rounded">
                                                        <div class="card-body">
                                                            <a href="{{ route('sosmed.create') }}" class="btn btn-md btn-success mb-3">TAMBAH SOSIAL MEDIA</a>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-center">
                                                                            <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('sosmed.destroy', $sosmed->id) }}" method="POST">
                                                                                <a href="{{ route('sosmed.edit', $sosmed->id) }}" class="btn btn-sm btn-primary">EDIT</a>
                                                                                @csrf
                                                                                @method('DELETE')
