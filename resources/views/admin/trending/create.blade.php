                                                        ...
                                                        <div class="card-body">
                                                            <form action="{{ route('trending.store') }}" method="POST" enctype="multipart/form-data">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title') }}" placeholder="Masukkan Judul Trending">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea class="form-control @error('content') is-invalid @enderror" name="content" rows="5" placeholder="Masukkan Konten Trending">{{ old('content') }}</textarea>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea class="form-control @error('kutipan') is-invalid @enderror" name="kutipan" rows="5" placeholder="Masukkan Konten Kutipan">{{ old('kutipan') }}</textarea>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea class="form-control @error('waktupost') is-invalid @enderror" name="waktupost" rows="5" placeholder="Masukkan Waktu Post Trending">{{ old('waktupost') }}</textarea>
