                                                        ...
                                                        <div class="card-body">
                                                            <form action="{{ route('trending.update', $trending->id) }}" method="POST" enctype="multipart/form-data">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title', $trending->title) }}" placeholder="Masukkan Judul Trending">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea class="form-control @error('content') is-invalid @enderror" name="content" rows="5" placeholder="Masukkan Konten Trending">{{ old('content', $trending->content) }}</textarea>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea class="form-control @error('kutipan') is-invalid @enderror" name="kutipan" rows="5" placeholder="Masukkan Konten Kutipan">{{ old('kutipan', $trending->kutipan) }}</textarea>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea class="form-control @error('waktupost') is-invalid @enderror" name="waktupost" rows="5" placeholder="Masukkan Waktu Post Trending">{{ old('waktupost', $trending->waktupost) }}</textarea>
