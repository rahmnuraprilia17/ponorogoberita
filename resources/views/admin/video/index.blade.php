                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="card border-0 shadow rounded">
                                                        <div class="card-body">
                                                            <a href="{{ route('video.create') }}" class="btn btn-md btn-success mb-3">TAMBAH VIDEO</a>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-center">
                                                                            <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('video.destroy', $video->id) }}" method="POST">
