        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#services">Blog Berita</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <section class="page-section" id="services">
        <div class="container">
            <div class="text-center">
                <h2 class="section-heading text-uppercase">Detail Blog</h2>
                <p class="text-muted">{{ $blogs->waktupost }}</p>
            </div>
            <br>
            <div class="row text-center">
                <div class="col-lg-6 order-1 order-lg-0">
                    <!-- <img class="img-fluid" src="{{ Storage::url('public/blogs/').$blogs->image }}" style="width: 120%;" style="height: 150%;" alt="..." /> -->
                    <img class="img-fluid" src="/gambar/{{$blogs->image}}" class="rounded" style="width: 120%;" style="height: 150%;" alt="..." />
                </div>
                <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1">
                    <h4 class="subheading">{{ $blogs->title }}</h4>
